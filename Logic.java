...
class Logic {
	...
	/*
	 * void show() { for(int i=0;i<9;i++) { System.out.println(); for(int j=0;j<9;j++)
	 * System.out.print(" "+blockS[i][j]); } System.out.println("\n"); System.out.println("\n"); blockS=save();
	 * for(int i=0;i<9;i++) { System.out.println(); for(int j=0;j<9;j++) System.out.print(" "+blockS[i][j]); }
	 * System.out.println("\n"); System.out.println("\n"); blockS=hide(); for(int i=0;i<9;i++) {
	 * System.out.println(); for(int j=0;j<9;j++) System.out.print(" "+blockS[i][j]); } }
	 */
	/*
	 * public static void main (String[] args) {
	 * 
	 * Logic ob=new Logic(); //ob.generate(); ob.show(); //System.out.println(); //ob.save(); //ob.show();
	 * //ob.hide(); //ob.show(); }
	 */
}